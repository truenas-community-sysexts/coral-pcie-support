...
| --- | --- | --- | --- | --- |
| Stable | `6.12.105-production+truenas` | 25.10.7 | Gasket 1.0-18.4 | [`k6.12.105-gasket1.0-18.4-r12`](https://github.com/truenas-community-sysexts/coral-pcie-support/releases/tag/k6.12.105-gasket1.0-18.4-r12) _(awaiting hardware-test promotion)_ |
