...
| --- | --- | --- | --- | --- |
| Stable | `6.12.105-production+truenas` | 25.10.7 | Gasket 1.0-18.4 | [`v25.10.7-gasket1.0-18.4-r11`](https://github.com/truenas-community-sysexts/coral-pcie-support/releases/tag/v25.10.7-gasket1.0-18.4-r11) _(awaiting hardware-test promotion)_ |
