...
# coral_init_script_lookup
#
# Locate any registered TrueNAS init script related to this fork (matches
# "coral-preinit", "coral-postinit", or ".config/coral" in the command/script
...
try:
    ...
    for s in scripts:
        ...
        if "coral-preinit" in cmd or "coral-postinit" in cmd or ".config/coral" in cmd:
